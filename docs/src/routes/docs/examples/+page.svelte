            ...
            {#each category.items as example, itemIndex}
                ...
                >
                    ...
                    <div class="relative z-10">
                        ...
                        <h3
                            class="mb-1.5 text-lg font-semibold text-foreground transition-colors group-hover:text-brand-600"
                        >
                            {example.title}
                        </h3>
                    ...
                    <!-- Decorative corner -->
                    <div
                        class="absolute top-0 right-0 h-16 w-16 rounded-bl-full bg-gradient-to-bl from-brand-500/10 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                    ></div>
                </a>
            {/each}
        </div>
...
<div class="not-prose mb-10">
    <h2 class="mb-4 text-xl font-semibold text-foreground">Quick Reference</h2>
    <div class="overflow-x-auto rounded-xl border border-border">
        <table class="w-full text-sm">
            <thead class="bg-muted/50">
                <tr>
                    <th class="px-4 py-3 text-left font-medium text-foreground">Use Case</th>
                    <th class="px-4 py-3 text-left font-medium text-foreground">Recommended TTL</th>
                    <th class="px-4 py-3 text-left font-medium text-foreground">Max Size</th>
                    <th class="px-4 py-3 text-left font-medium text-foreground">Key Pattern</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-border">
                {#each quickReference as row}
                    <tr class="transition-colors hover:bg-muted/30">
                        <td class="px-4 py-3 text-foreground">{row.useCase}</td>
