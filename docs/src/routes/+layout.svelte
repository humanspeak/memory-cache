<script lang="ts">
    ...
    const seo = $state<SeoContextType>({
        ...
        description: 'A lightweight, zero-dependency in-memory cache for TypeScript with TTL expiration, LRU eviction, and @cached decorator for method-level memoization.'
    })
</script>
